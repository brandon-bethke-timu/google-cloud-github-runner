...
class WebhookService:
    ...
    def handle_workflow_job(self, payload):
        ...
        if action == 'queued':
            ...
            if template_name:
                ...
                self._handle_queued_job(template_name, repo_name, org_name)
            else:
    ...
    def _handle_queued_job(self, template_name, repo_name, org_name):
        ...
        try:
            if org_name:
                ...
                self.gcloud_client.create_runner_instance(
                    jit_config,
                    template_name,
                    instance_name,
                    repo_name
